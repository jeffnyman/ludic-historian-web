1 REM LINE 5 CHANGED BY JASON DYER FOR MODERN SYSTEMS
2 REM "TIMER" ADDED TO AUTOMATICALLY SEED
3 REM RANDOMIZER RATHER THAN ASK FOR A SEED NUMBER, THIS
4 REM SEEMS TO MATCH THE BEHAVIOR OF THE PDP-10 IT PLAYED ON
5 RANDOMIZE TIMER
6 REM LINE 9 ADDED BY JASON DYER FOR MODERN SYSTEMS, IT MAKES
7 REM ARRAYS DEFINED STARTING AT 1 RATHER THAN 0
8 REM EARLY BASIC STARTED AT SUBSCRIPT 1 BY DEFAULT
9 OPTION BASE 1
10 DIM P(4, 2)
