...
170  GOSUB 5460
180  PRINT "                          STAR TREK "
190  PRINT '10'10'10"DO YOU WANT INSTRUCTIONS (THEY'RE LONG!)";
200  INPUT A$
...
340  S9=200
350  S=H8=0
360  DEF FND()=SQR((K[I,1]-S1)^2+(K[I,2]-S2)^2)
...
3120  PRINT '7"*** KLINGON DESTROYED ***"
3130  K3=K3-1
3140  K9=K9-1
...
3340  PRINT '7"*** STAR BASE DESTROYED ***  .......CONGRATULATIONS"
3350  B3=B3-1
3360  A$="   "
3370  Z1=INT(X+.5)
3380  Z2=INT(Y+.5)
...
4030  GOTO 230
4040  PRINT 
4050  PRINT "THE LAST KLIGON BATTLE CRUISER IN THE GALAXY HAS BEEN DESTROYED"
...
4690  PRINT '10"FUNCTIONS AVAILABLE FROM COMPUTER"'10
...
4810  NEXT I
4820  GOTO 1270
4830  PRINT '10"   STATUS REPORT"'10
...
5800  Z3=1
5810  RETURN 
5820  PRINT '10"     INSTRUCTIONS:"'10'10
5830  PRINT "<*> = ENTERPRISE"
5840  PRINT "+++ = KLINGON"
5850  PRINT ">!< = STARBASE"
5860  PRINT " *  = STAR"
5870  PRINT '10'10'10"COMMAND 0 = WARP ENGINE CONTROL"
5880  PRINT "  'COURSE IS IN A CIRCULAR NUMERICAL           4  3  2"
5890  PRINT "  VECTOR ARRANGEMENT AS SHOWN.                  "'92" ^ /"
5900  PRINT "  INTERGER AND REAL VALUES MAY BE                "'92"^/"
5910  PRINT "  USED.  THEREFORE COURSE 1.5 IS              5 ------ 1"
5920  PRINT "  HALF WAY BETWEEN 1 AND 2.                      /^"'92
5930  PRINT "                                                / ^ "'92
...
6010  PRINT '10'10"COMMAND 1 = SHORT RANGE SENSOR SCAN"
...
6050  PRINT '10'10"COMMAND 2 = LONG RANGE SENSOR SCAN"
...
6110  PRINT '10'10"COMMAND 3 = PHASER CONTROL"
...
6160  PRINT '10'10"COMMAND 4 = PHOTON TORPEDO CONTROL"
...
6290  PRINT "  DAMAGED."
6300  PRINT '10'10"COMMAND 7 = LIBRARY COMPUTER"
...
6400  PRINT "     AND ALL KLINGONS IN YOUR QUADRANT"'10'10'10'10'10
6410  RETURN 
6420  END 
